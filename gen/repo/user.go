...
type UserRepo interface {
	...
	Update(ctx context.Context, setCVs map[string]interface{}, incCVs map[string]interface{}, opts ...option.Option) (rowsAffected int64, err error)
...
func (s *UserRepoImpl) Update(ctx context.Context, setCVs map[string]interface{}, incCVs map[string]interface{}, opts ...option.Option) (rowsAffected int64, err error) {
...
func (s *UserRepoImpl) UpdateByID(ctx context.Context, id uint64, setCVs map[string]interface{}, incCVs map[string]interface{}) (rowsAffected int64, err error) {
	return s.Update(ctx, setCVs, incCVs, option.Where(model.ColUserID+" = ?", id))
}
...
func (s *UserRepoImpl) UpdateByIDs(ctx context.Context, ids []uint64, setCVs map[string]interface{}, incCVs map[string]interface{}) (rowsAffected int64, err error) {
	...
	return s.Update(ctx, setCVs, incCVs, option.Where(model.ColUserID+" in (?)", ids))
}
