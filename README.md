...
├── cmd  --------------------------  Main Entry
├── configs  ----------------------  Configs such as conf.yml
...
├── go.sum
├── internal
│   ├── biz  ----------------------  Business Logic, file name is basicly the same as table name
│   ├── common
...
│   ├── handler
│   │   ├── grpc  -----------------  GRPC Handler, file name is basicly the same as table name
│   │   └── http  -----------------  HTTP Handler, file name is basicly the same as table name
│   ├── repo  ---------------------  Repo Interface, file name is basicly the same as table name
│   ├── server
...
├── pkg  --------------------------  Common Packages
├── proto  ------------------------  Protobuf Files, including error.proto for custom error
├── README.md
