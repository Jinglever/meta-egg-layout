...
func (h *Handler) newUserDetailFromModel(ctx context.Context, mUser *model.User) (*UserDetail, error) {
	return &UserDetail{
		Id:        mUser.ID,
		Name:      mUser.Name,
		Gender:    mUser.Gender,
...
func (h *Handler) CreateUser(c *gin.Context) {
	...
	d, err := h.newUserDetailFromModel(c.Request.Context(), mUser)
	if err != nil {
		log.WithError(err).Error("newUserDetailFromModel failed")
		ResponseFail(c, err)
		return
	}
	ResponseSuccess(c, d)
...
func (h *Handler) newUserListInfoFromModels(ctx context.Context, msUser []*model.User) ([]*UserListInfo, error) {
...
func (h *Handler) GetUserList(c *gin.Context) {
	...
	list, err := h.newUserListInfoFromModels(c.Request.Context(), msUser)
	if err != nil {
		log.WithError(err).Error("newUserListInfoFromModels failed")
		ResponseFail(c, err)
		return
	}
